    ...
    if($terminationDate < $maturityDate) {
        ...
        if(!empty($chargeID)) {
            ...
            if($updateAccountBalance) {
                // insert client account transaction record into `account_transaction` table
                $newClientAccountTransactionData = [
                    'int_id' => $sessint_id,
                ...
                $insertClientAccountTransaction = insert('account_transaction', $newClientAccountTransactionData);

                if($insertClientAccountTransaction) {
