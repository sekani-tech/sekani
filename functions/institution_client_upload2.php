...
'{$country}', '{$state}', '{$lga}', '{$occupation}', '0', '{$sms_active}', '{$email_active}',
...
$res = mysqli_query($connection, $query);
 ...
 if ($res) {
    ...
    firstname, display_name, date_of_birth, submittedon_date, email_address, ADDRESS, COUNTRY,
      ...
      '{$sig_lga_one}','{$sig_lga_two}','{$sig_lga_three}', '{$sig_occu_one}', '{$sig_occu_two}', '{$sig_occu_three}', '0','0','0','{$sms_active_one}','{$sms_active_two}','{$sms_active_three}',
