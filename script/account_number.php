...
while ($row = mysqli_fetch_array($account_table)) {
    ...
    $update_account = mysqli_query($connection, "UPDATE account SET account_no = '$acc' WHERE client_id = '$client_id'");
}
...
while ($rx = mysqli_fetch_array($client_table)) {
    ...
    $update_client = mysqli_query($connection, "UPDATE client SET account_no = '$acc1' WHERE id = '$id'");
}
if ($update_account) {
