...
<?php
  ...
  function fill_report($connection)
        ...
        $query = "SELECT * FROM endofmonth_tb WHERE int_id = '$int_id'";
        ...
        while ($q = mysqli_fetch_array($result, MYSQLI_ASSOC))
          {
            ...
            <th style="font-size: 12px;" class="column1">'.$monthe.'</th>
            <th style="font-size: 12px;" class="column1">'.$yearc.'</th>
            </tr>
          ';
          }
        // }
...
<h1>'.$_SESSION["int_full"].' <br/> End of Month</h1>
...
<div id="project">
 ...
 MONTH CLOSED
  ...
  ');
  $file_name = 'End of Month for -'.$date.'.pdf';
