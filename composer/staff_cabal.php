...
if(isset($_POST["start"]) && isset($_POST["end"])){
  ...
  <tbody>
  "'.fill_stafff($connection, $int_id, $start, $end, $branch_id, $role).'"
  <tr>
              <th>Total</th>
              <th></th>
              <th>'.$totalcurrent.'</th>
               <th>'.number_format($totalcurrentamount).'</th>
               <th>'.$totalsavings.'</th>
               <th>'.number_format($totalsavingsamount).'</th>
               <th>'.$totalloans.'</th>
               <th>'.number_format($totalloansamount).'</th>
              </tr>
  </tbody>
  </table>
  </main>
