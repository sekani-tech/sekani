...
Group_Details_Meeting_Time INT, Group_Details_Geographical_Region VARCHAR(100), Group_Details_Submitted_On_Date DATE,
PRIMARY KEY (id)
);
...
Loan_Collateral_Submitted_By_User VARCHAR(100), Loan_Collateral_Submitted_On_Date DATE,	Loan_Collateral_Descrition_Of_Asset5 VARCHAR(100), Loan_Collateral_Approximate_Cos6 VARCHAR(100),
PRIMARY KEY (id)
);
...
Parent_Product_Group VARCHAR(100), Transaction_Id VARCHAR(100), Effective_Date DATE, Submitted_On_Date DATE,
PRIMARY KEY (id)
);
