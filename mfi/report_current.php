                    ...
                    <table id="tabledat" class="table" cellspacing="0" style="width:100%">
                      ...
                      <!-- <?php if (mysqli_num_rows($result) > 0) {
                        ...
                        <?php }
                          ...
                          <!-- <th></th> -->
                          <tr>
                          <th>General Current Account Report</th>
                          <th>Current Accounts</th>
                          <th>The report list all the accured interest within the specified time period</th>
                          <td><a href="Current Accounts_report_view.php?edit=1" class="btn btn-info"><i class="material-icons">description</i></a></td>
                        </tr>
                        <tr>
                          <th>Current Account Rep By Branch</th>
                          <th>Current Accounts</th>
                          <th>The report list all the accured interest  disbursed within the specified time period</th>
                          <td><a href="Current Accounts_report_view.php?edit=2" class="btn btn-info"><i class="material-icons">description</i></a></td>
                        </tr>
                        <tr>
                          <th>Current Account Analysis</th>
                          <th>Current Accounts</th>
                          <th>Balance Sheet</th>
                          <td><a href="Current Accounts_report_view.php?edit=3" class="btn btn-info"><i class="material-icons">description</i></a></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
