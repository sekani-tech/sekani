            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Savings Reports</h4>
                  <script>
                  $(document).ready(function() {
                  $('#tabledat').DataTable();
                  });
                    ...
                    <table id="tabledat" class="table" cellspacing="0" style="width:100%">
                      ...
                      <!-- <?php if (mysqli_num_rows($result) > 0) {
                        ...
                        <?php }
                          ...
                          <td><a href="Savings_report_view.php?edit=1" class="btn btn-info"><i class="material-icons">description</i></a></td>
                        </tr>
                        <tr>
                          <th>Savings Account Analysis</th>
                          <th>Savings</th>
                          <th>The report list all the accured interest  disbursed within the specified time period</th>
                          <td><a href="Savings_report_view.php?edit=2" class="btn btn-info"><i class="material-icons">description</i></a></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
