                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="../functions/institution_client_upload.php" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="acct_type" class="form-control"
                                                    data-style="btn btn-link" id="collat">
                                ...
                                <input type="submit" value="Create Client" name="submit" id="submit" disabled
