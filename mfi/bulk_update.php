                            ...
                            <div class="table-responsive">
                                <table class="rtable display nowrap" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="bulk_charge_data.php" class="btn btn-info"><i
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="bulk_client_data.php" class="btn btn-info"><i
                                                        class="material-icons"
                                                        style="margin: auto;">description</i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><a href="bulk_general_lender_data.php" class="btn btn-info"><i
                                                        class="material-icons" style="margin: auto;">description</i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><a href="bulk_group_data.php" class="btn btn-info"><i class="material-icons"
                                                                                                  style="margin: auto;">description</i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><a href="bulk_loan_data.php" class="btn btn-info"><i class="material-icons"
                                                                                                 style="margin: auto;">description</i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><a href="bulk_product_data.php" class="btn btn-info"><i
                                                        class="material-icons"
                                                        style="margin: auto;">description</i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><a href="bulk_report_data.php" class="btn btn-info"><i
                                                        class="material-icons"
                                                        style="margin: auto;">description</i></a>
                                        </td>
                                    </tr>
