                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            ...
                            ?>
                            <h4 class="card-title ">Disbursed Loans Accounts - Total Outstanding
                                NGN <?php echo number_format(round($fde), 2); ?></h4>
                        ...
                        <div class="card card-profile ml-auto mr-auto" style="max-width: 370px; max-height: 360px">
                            ...
                            <form method="POST" action="../composer/disbursedloan.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="int_id" hidden name=""
                                                   value="<?php echo $sessint_id; ?>" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <!--                                    Select Branch area-->
                                    <div class="col-md-4">
                                ...
                                <button type="submit" id="excel" class="btn btn-success pull-right">Download Excel
                                </button>
                            </form>
                        </div>
                    </div>
            ...
            $(document).ready(function () {
                $('#group_id').change(function () {
                    ...
                    $.ajax({
                        ...
                        method: "POST",
                        data: {group_id: group_id, endDate: endDate, startDate: startDate, sint_id: sint_id},
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!--                          <th>-->
                                <?php //echo $row["principal_amount"]; ?><!--</th>-->
                                <!--                          <th>-->
                                <?php //echo $row["disbursement_date"];?><!--</th>-->
                                ...
                                <?php //echo $row["id"];?><!--" class="btn btn-info">View</a></td>-->
                                <!--                         </tr>-->
                                <!--                        --><?php //}
                                //                          }
                                //                          else {
