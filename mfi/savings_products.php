              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">
                   <a class="btn btn-primary" href="create_savings_products">Create Savings Products</a>
                   <a href="create_deposit_product" class="btn btn-primary">Create Fixed Term Deposit Saving Product</a>
