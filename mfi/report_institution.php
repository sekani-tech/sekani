            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">institution Reports</h4>
                  <script>
                  $(document).ready(function() {
                  $('#tabledat').DataTable();
                  });
                    ...
                    <table id="tabledat" class="table" cellspacing="0" style="width:100%">
                      ...
                      <!-- <?php if (mysqli_num_rows($result) > 0) {
                        ...
                        <?php }
                          ...
                          <th>institution</th>
                          <th>Balance Sheet</th>
                          <td><a href="institution_report_view.php?edit=3" class="btn btn-info"><i class="material-icons">description</i></a></td>
                        </tr>
                          <tr>
                          <th>Vault Report</th>
                          <th>institution</th>
                          <th>The report list all the accured interest within the specified time period</th>
                          <td><a href="institution_report_view.php?edit=1" class="btn btn-info"><i class="material-icons">description</i></a></td>
                        </tr>
                        <tr>
                          <th>Teller Report</th>
                          <th>institution</th>
                          <th>The report list all the accured interest  disbursed within the specified time period</th>
                          <td><a href="institution_report_view.php?edit=2" class="btn btn-info"><i class="material-icons">description</i></a></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
