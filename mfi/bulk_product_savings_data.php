...
$page_title = "Product Savings Data";
$destination = "bulk_product_data.php";
include("header.php");
...
<div class="col-md-12">
            ...
            <!-- Saving Account Rule Data Begins -->
            <div class="card">
                 <div class="card-header card-header-primary">
                            <h4 class="card-title">Saving Account Rule Data</h4>
                            <p class="category"></p>
                     </div>
                        ...
                        <button class="btn btn-primary btn-lg ">
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- Saving Product Data Begins -->
                                        <div class="card">
                                        <div class="card-header card-header-primary">
                                                <h4 class="card-title">Saving Product Data</h4>
                                                <p class="category"></p>
                                            </div>
                                            <div class="card-body">
                                            <div class="row">
                                    ...
                                    <span class="input-group-btn">
                                        ...
                                        <!-- Saving Account Rule Data Ends -->

                                      <!-- Saving Product Charge Begins -->
                                        <div class="card">
                                        <div class="card-header card-header-primary">
                                                <h4 class="card-title">Saving Product Charge</h4>
                                                <p class="category"></p>
                                            </div>
                                            <div class="card-body">
                                            <div class="row">
