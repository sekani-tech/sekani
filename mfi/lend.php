...
<!--                                                script for client information displayed on div with id= show_product-->
                                                <script>
                                                    $(document).ready(function () {
                          ...
                          <button type="button" class="btn btn-primary" name="button" onclick="displayCharge()"> <i class="fa fa-plus"></i> Add To Product </button>
                                            ...
                                            <div class="tab"><h3>KYC:</h3>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class=" col-md-6 form-group">
                                                        ...
                                                        <select class="form-control" name="emp_category">
                                                            ...
                                                            <option value="INFORMATION AND COMMUNICATION">INFORMATION
                                                                AND
                                                                COMMUNICATION
                                                            </option>
                                                    ...
                                                    <div class=" col-md-6 form-group">
                                                        <label class="bmd-label-floating">Monthly
                                                            Income(&#x20a6;):</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- <div id="rent"> -->
                                                    <div class=" col-md-6 form-group">
                                                        <label class="bmd-label-floating">Rent per Year (if
                                                            rented):</label>
                                                    ...
                                                    <div class=" col-md-6 form-group">
                                                        ...
                                                        <select class="form-control" name="other_banks">
                                                            <option value="GUARANTY TRUST BANK">GUARANTY TRUST BANK
                                                            </option>
                                                            ...
                                                            <option value="UNITED BANK FOR AFRICA">UNITED BANK FOR
                                                                AFRICA
                                                            </option>
                                            ...
                                            <div class="tab"><h3> Overview:</h3>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <input readonly type="text" name="loan_officer"
                                                               class="form-control"
                                                               id="lo">
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label class="bmd-label-floating">Loan Purpose:</label>
                                                        <input readonly type="text" name="loan_purpose"
                                                               class="form-control"
                                                               id="lp">
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label class="bmd-label-floating">Linked Savings
                                                            account:</label>
