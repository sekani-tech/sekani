                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <script>
                                                        $(document).ready(function() {
                                                            ...
                                                            $('#act_no').on("change keyup paste", function() {
                                                                ...
                                                                var ist = $('#int_id').val();
                                                                $.ajax({
                                                                    url: "ajax_post/loan/lenders_info.php",
                                                                    method: "POST",
                                                                    data: {
                                                                        id: id,
                                                                        ist: ist
                                            ...
                                            <div style="overflow:auto;">
                                                <div style="float:right;">
                                                    <button class="btn btn-primary pull-right" type="button" id="nextBtn" onclick="nextPrev(1)">Next
                                                    </button>
                                                    <button class="btn btn-primary pull-right" type="button" id="prevBtn" onclick="nextPrev(-1)">Previous
                                                    </button>
                                                </div>
                                            </div>
                                            <!-- Steppers -->
