        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <?php
              ...
              <a class="btn btn-primary" href="javascript:history.go(-1)"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
