...
if (!empty($_POST['start']) && !empty($_POST['end'])) {
    ...
    ?>
<table id="endofmonth" class="table table-striped table-bordered" style="width:100%">
<thead class="">
<?php
...
while ($row = mysqli_fetch_assoc($result)) { ?>
  ...
  $idd = $row["id"];?>
   <input type="hidden" id="toggleID" value="<?php echo $row[ 'id']; ?>">
    ...
    <th> <?php echo $row['monthend']; ?></th>
    <th> <?php echo $row['yearclosed']; ?></th>
 ...
 <div class="form-group mt-4">
              <form method="POST" action="../composer/endofmonth.php">
