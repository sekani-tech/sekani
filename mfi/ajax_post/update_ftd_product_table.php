...
?>
<?php
$dsd = "SELECT * FROM `ftd_product_charge` WHERE int_id = '$sessint_id' AND ftd_id = '$user_id' AND charge_id='$charge'";
...
$fdfg = "INSERT INTO ftd_product_charge (int_id, ftd_id, charge_id) VALUES('{$sessint_id}', '{$user_id}', '{$charge}')";
