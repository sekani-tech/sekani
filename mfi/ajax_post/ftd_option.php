...
if(isset($_POST['id'])){
    ...
    $fd = '
        ...
        <div class="form-group">
          ...
          <div id="verrify"></div>
          <input type="number" id ="dep" value = "'.$dep_amount.'" class="form-control" name="amount" required>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input type="text" hidden class="form-control" value ="'.$int_post_type.'"  name="int_post" required>
        </div>
      </div>
      <div class="col-md-4">
      <div class="form-group">
        <label>Linked Savings account:</label>
        <select name="linked_savings_acct" class="form-control" id="lsaa" required>
