                    ...
                    <div class="row">
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" readonly name="staff_id" readonly value="<?php echo $staff_id; ?>" class="form-control">
                          <input type="text" readonly name="user_id" hidden readonly value="<?php echo $us_id; ?>" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">Institution</label>
                          <input type="text" name="int_name" readonly value="<?php echo $int_name; ?>" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="branch_id" value="<?php echo $email; ?>" readonly class="form-control">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="date" name="date_joined" readonly value="<?php echo $date_joined; ?>" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                      <?php
                    ...
                    <style>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="usertype" value="<?php echo $usertype; ?>" class="form-control" readonly>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
