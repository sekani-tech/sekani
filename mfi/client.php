                    ...
                    <div class="card">
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-category"><?php
                                ...
                                echo $inr;
                                ?> registered clients || <a style="color: white;" href="manage_client.php">Create New
                                    client</a></p>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) { ?>
                                            <tr>
                                                ...
                                                ?>
                                                <th><?php echo $acc; ?></th>
                                                <td><a href="client_view.php?edit=<?php echo $row["id"]; ?>"
                                                       class="btn btn-info">View</a></td>
                                                <td>
                                                    <a href="../functions/close_client.php?edit=<?php echo $row["id"]; ?>"
                                                       class="btn btn-info">Close</a></td>
                                            </tr>
                                        <?php }
                                    }
                                    ?>
